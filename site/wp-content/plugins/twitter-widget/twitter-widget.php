...
function widget_Twidget_init() {
	...
	function widget_Twidget($args) {
		...
		echo '<div id="twitter_div">'
              .$before_title."Follow us on:<br /><br /><a href='http://facebook.com/RiotRadioNZ' target='_blank'><img src='/wp-content/themes/riotradio/images/facebook_logo.png' alt='Facebook' width='80' border='0' style='padding-left:5px;' /></a><a href='http://twitter.com/RiotRadioNZ' target='_blank'><img src='/wp-content/themes/riotradio/images/twitter_logo.png' alt='Twitter' width='80' border='0' align='right' /></a><br /><br />Latest Tweets:".$after_title;
